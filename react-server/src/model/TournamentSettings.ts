...
export default class TournamentSettings {
    ...
    constructor(tournamentId: number, voters: TournamentVoter[], currentRoundDescription: string, matchDescriptions: MatchDescription[], roundDates: RoundDate[]) {
    ...
    static fromJson(data: any): TournamentSettings {
        ...
        return new TournamentSettings(data.tournamentId, voters, data.currentRoundDescription, matchDescriptions, roundDates);
    }

    setVoters(voters: TournamentVoter[]): TournamentSettings {
        return new TournamentSettings(this.tournamentId, voters, this.currentRoundDescription, this.matchDescriptions, this.roundDates);
    }
    ...
    setCurrentRoundDescription(description: string): TournamentSettings {
        return new TournamentSettings(this.tournamentId, this.voters, description, this.matchDescriptions, this.roundDates);
    }
    ...
    setMatchDescription(description: string, matchIndex: number, songIndex: number): TournamentSettings {
        ...
        return new TournamentSettings(this.tournamentId, this.voters, this.currentRoundDescription, matchDescriptions, this.roundDates);
    }
    ...
    setRoundStartDate(roundIndex: number, startDate: Date): TournamentSettings {
        ...
        return new TournamentSettings(this.tournamentId, this.voters, this.currentRoundDescription, this.matchDescriptions, roundDates);
    }
